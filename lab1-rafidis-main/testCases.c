...
//=================Question 2================================
    ...
    void TestQ2_true_exact(CuTest *tc) {
...
//=================Question 7================================  
    ...
    CuSuite* Lab1GetSuite() {
        ...
        SUITE_ADD_TEST(suite, TestQ2_true_exact);
        ...
        SUITE_ADD_TEST(suite, TestQ3_3_close);
        ...
        SUITE_ADD_TEST(suite, TestQ6_20);
