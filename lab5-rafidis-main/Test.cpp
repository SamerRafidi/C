...
void testSLLSetIntArray2() {
// Added
        int arr[] = {3, 4, 5, 6, 7}; // this list

        SLLSet listObj2 = SLLSet(arr,5);
        string expectedSet = "3, 4, 5, 6, 7";
        int expectedSize = 5;
        ASSERT_EQUAL(expectedSize,listObj2.getSize());
        ASSERT_EQUAL(expectedSet,listObj2.toString());
	}
...
// Added
		...
		SLLSet copied = listObj2.copy();
        copied.add(200);
        string expectedObj2 = "3, 4, 5, 6, 7";
        string expectedCopied = "3, 4, 5, 6, 7, 200";
        int expectedObj2Size = 5;
        int expectedCopiedSize = 6;
...
// Added
    ...
    SLLSet listObj2 =  SLLSet(arr,5);
        ...
        string expectedObj2 = "2, 3, 4, 5, 6, 7";
        int expectedObj2Size = 6;
...
// Added
    ...
    SLLSet listObj2 =  SLLSet(arr,5);
        ...
        int removefirst = 3;  // test remove

        //test remove

        listObj2.remove(removefirst);

        string expectedObj2 = "4, 5, 6, 7";
        int expectedObj2Size = 4;
...
// Added
    ...
    int arr2[] = {0, 2, 4, 6}; // this list
    SLLSet listObj11 =  SLLSet(arr2,4);
